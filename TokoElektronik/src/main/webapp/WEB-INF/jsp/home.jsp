...
<link
	href="/assets/gentelella-master/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
	rel="stylesheet">
<!-- JQVMap -->
<link
	href="/assets/gentelella-master/vendors/jqvmap/dist/jqvmap.min.css"
	rel="stylesheet" />
...
<body class="nav-md">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="/assets/gentelella-master/production/images/img.jpg"
									alt=""> <c:forEach var="karyawan" items="${karyawan }">
								${karyawan.namaK }
	...
	<!-- Chart.js -->
	<script
		src="/assets/gentelella-master/vendors/Chart.js/dist/Chart.min.js"></script>
	<!-- gauge.js -->
	<script
		src="/assets/gentelella-master/vendors/gauge.js/dist/gauge.min.js"></script>
	<!-- bootstrap-progressbar -->
	<script
	...
	<script
		src="/assets/gentelella-master/vendors/Flot/jquery.flot.time.js"></script>
	<script
		src="/assets/gentelella-master/vendors/Flot/jquery.flot.stack.js"></script>
	<script
		src="/assets/gentelella-master/vendors/Flot/jquery.flot.resize.js"></script>
	<!-- Flot plugins -->
	<script
		src="/assets/gentelella-master/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
	<script
		src="/assets/gentelella-master/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
	<script
		src="/assets/gentelella-master/vendors/flot.curvedlines/curvedLines.js"></script>
	<!-- DateJS -->
	<script src="/assets/gentelella-master/vendors/DateJS/build/date.js"></script>
	<!-- JQVMap -->
	<script
		src="/assets/gentelella-master/vendors/jqvmap/dist/jquery.vmap.js"></script>
	<script
		src="/assets/gentelella-master/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
	<script
		src="/assets/gentelella-master/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
	<!-- bootstrap-daterangepicker -->
	<script
